...
.method public declared-synchronized init(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/arcsoft/avatar2/util/TimeConsumingUtil;->startTheTimer(Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/arcsoft/avatar2/AvatarEngine;->nativeCreate()J

    move-result-wide v1

    iput-wide v1, p0, Lcom/arcsoft/avatar2/AvatarEngine;->f:J

    invoke-direct {p0, v1, v2, p1, p2}, Lcom/arcsoft/avatar2/AvatarEngine;->nativeInit(JLjava/lang/String;Ljava/lang/String;)I
...
.method public declared-synchronized outlineProcess([BIIII)I
    ...
    const-string v0, "nativeOutlineProcess = "

    monitor-enter p0

    :try_start_0
    new-instance v11, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;

    invoke-direct {v11}, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;-><init>()V

    const-string v1, "outlineProcess"

    invoke-static {v1}, Lcom/arcsoft/avatar2/util/TimeConsumingUtil;->startTheTimer(Ljava/lang/String;)V

    iget-wide v2, v10, Lcom/arcsoft/avatar2/AvatarEngine;->f:J
    ...
    invoke-direct/range {v1 .. v9}, Lcom/arcsoft/avatar2/AvatarEngine;->nativeOutlineProcess(J[BIIIILcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;)I

    move-result v1

    const-string v2, "performance"

    const-string v3, "outlineProcess"

    invoke-static {v2, v3}, Lcom/arcsoft/avatar2/util/TimeConsumingUtil;->stopTiming(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v11}, Lcom/arcsoft/avatar2/AvatarEngine;->checkOutlineInfo(Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;)I
...
.method public declared-synchronized outlineProcessEx(Lcom/arcsoft/avatar2/util/ASVLOFFSCREEN;I)I
    ...
    :try_start_0
    new-instance v7, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;

    invoke-direct {v7}, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;-><init>()V

    const-string v1, "outlineProcessEx"
    ...
    invoke-direct/range {v1 .. v6}, Lcom/arcsoft/avatar2/AvatarEngine;->nativeOutlineProcessEx(JLcom/arcsoft/avatar2/util/ASVLOFFSCREEN;ILcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;)I
    ...
    invoke-static {p2, v1}, Lcom/arcsoft/avatar2/util/TimeConsumingUtil;->stopTiming(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v7}, Lcom/arcsoft/avatar2/AvatarEngine;->checkOutlineInfo(Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarProcessInfo;)I
...
.method public setHeadWearGrayPath(Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigInfo;)V
    ...
    const-string v1, "/cartoon_HEADWEAR/style21/Tex_21_gray_alpha20.png"
...
.method public declared-synchronized unInit()V
    ...
    invoke-direct {p0, v1, v2}, Lcom/arcsoft/avatar2/AvatarEngine;->nativeUnInit(J)I
