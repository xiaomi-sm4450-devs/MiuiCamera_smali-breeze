...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v4}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    new-instance v9, Lfl/b;

    invoke-direct {v9}, Lfl/b;-><init>()V
    ...
    invoke-virtual {v9, v10, v11}, Lfl/b;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v9}, Lfl/b;->b()V

    iput-boolean v11, v9, Lfl/b;->l:Z
    :try_end_1
    ...
    invoke-static {v2, v1}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lfl/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v4}, Lel/n;->z(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v4, p0}, Lfl/a;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    :cond_2
    invoke-static {p0}, Lel/h;->j([Ljava/lang/Object;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v5, v6}, Lfl/f;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_5
    invoke-static {v5}, Lbg/a;->b(Lfl/f;)Lfl/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {v8, v11}, Lkotlin/jvm/internal/i;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lel/n;->z(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v5}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v5

    :cond_3
    :try_start_1
    invoke-virtual {v4, v6}, Lfl/f;->add(Ljava/lang/Object;)Z

    goto :goto_0

    :cond_4
    invoke-static {v4}, Lbg/a;->b(Lfl/f;)Lfl/f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
