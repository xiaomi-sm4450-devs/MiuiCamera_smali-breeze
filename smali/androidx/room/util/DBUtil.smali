...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v2}, Lfl/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {v0}, Ldp/c;->b(Lfl/a;)Lfl/a;

    invoke-virtual {v0}, Lfl/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v1, Lfl/a$a;

    invoke-virtual {v1}, Lfl/a$a;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lfl/a$a;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Lwl/i;->I(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final processForeignKeyCheckFailure(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v1, v4, v2}, Landroidx/constraintlayout/core/parser/b;->i(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
