...
.method public resize(D)V
    ...
    .line 6
    invoke-virtual {v0, p1}, Lorg/apache/poi/hssf/usermodel/HSSFClientAnchor;->setCol2(S)V

    const/4 p1, 0x0

    .line 7
    invoke-virtual {v0, p1}, Lorg/apache/poi/hssf/usermodel/HSSFClientAnchor;->setDx1(I)V
    ...
    .line 10
    invoke-virtual {v0, p1}, Lorg/apache/poi/hssf/usermodel/HSSFClientAnchor;->setDy1(I)V
...
.method public setShapeType(I)V
    ...
    const-string v0, "Shape type can not be changed in "
