...
.method public static subscribe(Lcq/c;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p0, v0}, Lcq/c;->onSubscribe(Lcq/d;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorSubscription;-><init>(Lcq/c;Ljava/util/Iterator;)V
...
.method public subscribeActual(Lcq/c;)V
    ...
    invoke-static {p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable;->subscribe(Lcq/c;Ljava/util/Iterator;)V
