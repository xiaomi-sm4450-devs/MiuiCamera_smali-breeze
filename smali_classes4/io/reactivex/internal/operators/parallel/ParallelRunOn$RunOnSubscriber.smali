...
# direct methods
.method public constructor <init>(Lcq/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcq/c;
...
.method public onSubscribe(Lcq/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcq/c;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcq/c;
    ...
    invoke-interface {v3, v15}, Lcq/c;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_6
    invoke-interface {v3, v15}, Lcq/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v3, v13}, Lcq/c;->onError(Ljava/lang/Throwable;)V
