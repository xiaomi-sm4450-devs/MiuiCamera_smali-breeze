...
.method public static parseDebugConfig()Lmiuix/animation/internal/AnimDebugger$StateDebugInfo;
    ...
    const-string v1, "get debug.design.folme: "

    const/4 v2, 0x0

    :try_start_0
    const-string v3, "debug.design.folme"

    .line 1
    invoke-static {v3}, Lmiuix/animation/utils/CommonUtils;->readProp(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 13
    invoke-virtual {v8, v6, v1, v4}, Lmiuix/animation/base/AnimConfig;->setSpecial(Ljava/lang/String;Lmiuix/animation/utils/EaseManager$EaseStyle;[F)Lmiuix/animation/base/AnimConfig;
