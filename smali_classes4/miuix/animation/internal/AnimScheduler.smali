...
.method private static changeRunningPropertyOp(Lmiuix/animation/listener/UpdateInfo;Lmiuix/animation/internal/AnimOperationInfo;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/IAnimTarget;)V
    ...
    invoke-static {v5, v4, v6}, Lab/o;->c(Ljava/lang/String;ZLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private doOperationForUpdateInfoList(Lmiuix/animation/internal/TransitionInfo;Lmiuix/animation/internal/AnimOperationInfo;Lmiuix/animation/internal/AnimStats;Ljava/util/List;)V
    ...
    :goto_0
    iget-object v3, p1, Lmiuix/animation/internal/TransitionInfo;->animTasks:Ljava/util/List;
    ...
    iget v5, v4, Lmiuix/animation/internal/AnimTask;->startPos:I

    invoke-virtual {v4}, Lmiuix/animation/internal/AnimTask;->getAnimCount()I
    ...
    iget-object v8, v4, Lmiuix/animation/internal/AnimTask;->animStats:Lmiuix/animation/internal/AnimStats;

    invoke-static {v7, v8, p3}, Lmiuix/animation/internal/AnimScheduler;->handleSetToPropertyOnUpdate(Lmiuix/animation/listener/UpdateInfo;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/internal/AnimStats;)Z
    ...
    const-string v9, "doSetTo "

    invoke-static {v9, v8}, Landroidx/constraintlayout/core/parser/b;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    const-string v9, " |---- step0"

    invoke-static {v9, v2}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v2, v4, Lmiuix/animation/internal/AnimTask;->animStats:Lmiuix/animation/internal/AnimStats;

    iget-object v8, p1, Lmiuix/animation/internal/TransitionInfo;->target:Lmiuix/animation/IAnimTarget;

    invoke-static {v7, p2, v2, p3, v8}, Lmiuix/animation/internal/AnimScheduler;->changeRunningPropertyOp(Lmiuix/animation/listener/UpdateInfo;Lmiuix/animation/internal/AnimOperationInfo;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/internal/AnimStats;Lmiuix/animation/IAnimTarget;)V

    if-eqz p0, :cond_3

    new-instance v2, Ljava/lang/StringBuilder;

    const-string v7, " |---- step2 changeRunningPropertyOp finish taskInfo "

    invoke-direct {v2, v7}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v7, v4, Lmiuix/animation/internal/AnimTask;->info:Lmiuix/animation/internal/TransitionInfo;
    ...
    invoke-static {v2, v7}, Lmiuix/animation/utils/LogUtils;->debug(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private updateTarget(Lmiuix/animation/IAnimTarget;Ljava/util/List;)Z
    ...
    const-string v14, "--- notifyTransitionEndOrCancel from updateTarget msg="
    ...
    invoke-static {v14, v8}, Landroid/support/v4/media/a;->c(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v0, v8}, Landroid/support/v4/media/a;->c(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final update()V
    ...
    invoke-static {v3, v2, v6, v4}, Lab/o;->b(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
