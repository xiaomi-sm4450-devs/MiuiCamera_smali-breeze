...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-direct {v5, v0, v4}, Ldl/g;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    aput-object v5, v1, v2

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-static {v3}, Lke/b0;->z(I)I
    ...
    iget-object v4, v1, Ldl/g;->a:Ljava/lang/Object;
    ...
    invoke-static {v1}, Lel/n;->z(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {v1}, Lel/h;->j([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v1}, Lel/n;->A(Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v2}, Lel/n;->w(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lpl/l;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_5
    invoke-static {v5, v11}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_8
    invoke-static {v5, v1}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v3, v11}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    :try_start_b
    invoke-static {v3, v1}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, v6}, Lpl/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v11}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, Lbg/a;->d(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lpl/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lpl/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v2, v3}, Lwl/m;->K(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILpl/p;)V
    ...
    invoke-static {v9, v1, v4}, Lwl/i;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final readExtra(Lokio/BufferedSource;ILpl/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lpl/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILpl/p;)V
