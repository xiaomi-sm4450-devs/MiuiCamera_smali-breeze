...
.method public createSpContainer(Z)Lorg/apache/poi/ddf/EscherContainerRecord;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lorg/apache/poi/ddf/EscherClientAnchorRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I
...
.method public getClientRecords()[Lorg/apache/poi/hslf/record/Record;
    ...
    invoke-virtual {v2, v0, v1, v3}, Lorg/apache/poi/ddf/EscherClientDataRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I
...
.method public getLogicalAnchor2D()Ljava/awt/geom/Rectangle2D;
    ...
    invoke-virtual {v1, v3, v4, v7, v8}, Ljava/awt/geom/AffineTransform;->translate(DD)V
    ...
    invoke-virtual {v1, v5, v6}, Ljava/awt/geom/AffineTransform;->rotate(D)V

    neg-double v5, v3

    neg-double v9, v7

    invoke-virtual {v1, v5, v6, v9, v10}, Ljava/awt/geom/AffineTransform;->translate(DD)V
    ...
    invoke-virtual {p0, v3, v4, v7, v8}, Ljava/awt/geom/AffineTransform;->translate(DD)V

    const-wide v1, 0x3ff921fb54442d18L    # 1.5707963267948966

    invoke-virtual {p0, v1, v2}, Ljava/awt/geom/AffineTransform;->rotate(D)V

    invoke-virtual {p0, v5, v6, v9, v10}, Ljava/awt/geom/AffineTransform;->translate(DD)V
